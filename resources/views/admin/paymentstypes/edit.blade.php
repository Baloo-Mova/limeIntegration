...
@section('contentheader_title')
    <i class='fa fa-money'></i>   Админ. Изменение вида оплаты. Идентификационный номер: {{$paymentstype->id}}
@endsection
                        ...
                        <div class="col-md-offset-2">
                            <div class="col-md-10">
                                <div class="form-group {{ $errors->has('title')?'has-danger':'' }}">
                                    ...
                                    <input type="text" value="{{$paymentstype->title}}" name="title"
                        ...
                        <div class="col-md-offset-2">
                            <div class="col-md-10">
                                <div class="form-group {{ $errors->has('weight_global')?'has-danger':'' }}">
                                    ...
                                    <input type="number" value="{{$paymentstype->weight_global}}" name="weight_global"
                                           class="form-control"
                                           id="weight_global">
